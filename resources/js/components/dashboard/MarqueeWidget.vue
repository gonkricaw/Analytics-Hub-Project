<template>
  ...
  <div
    v-if="!isEnabled"
    class="marquee-widget bg-gradient-to-r from-gray-500 to-gray-600 rounded-lg shadow-md p-4 h-full overflow-hidden relative opacity-60"
  >
    <div class="flex items-center justify-center h-20">
      <div class="text-center">
        <svg
          class="w-6 h-6 mx-auto text-white/60 mb-2"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <p class="text-white/80 text-sm">
          Marquee announcements are disabled
        </p>
      </div>
    </div>
  </div>
  ...
  <div
    v-else-if="error"
    class="marquee-widget bg-gradient-to-r from-red-600 to-red-700 rounded-lg shadow-md p-4 h-full overflow-hidden relative"
  >
    <div class="flex items-center justify-center h-20">
      <div class="text-center">
        <svg
        ...
        <button
          class="mt-1 text-white hover:text-white/80 text-xs underline"
          @click="fetchData"
        >
          Retry
        </button>
  ...
  <div
    ...
    class="marquee-widget bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-md p-4 h-full overflow-hidden relative"
  >
    <div class="flex items-center justify-center h-20">
      <div class="text-center">
        <svg
  ...
  >
    ...
    <div class="relative h-20 overflow-hidden">
      <!-- Gradient Overlays -->
      <div class="absolute left-0 top-0 w-8 h-full bg-gradient-to-r from-blue-600 to-transparent z-10 pointer-events-none" />
      <div class="absolute right-0 top-0 w-8 h-full bg-gradient-to-l from-purple-600 to-transparent z-10 pointer-events-none" />
      
      <!-- Scrolling Content -->
      <div
        class="marquee-content flex items-center h-full whitespace-nowrap" 
        :class="{ 'paused': isPaused }"
        :style="{ animationDuration: animationDuration }"
      >
        <div
          v-for="(announcement, index) in repeatableAnnouncements" 
        ...
        >
          ...
          <div class="flex-shrink-0 mr-3">
            <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <svg
                v-else-if="announcement.type === 'success'"
                class="w-4 h-4 text-white"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
          ...
          <!-- Separator -->
          <div class="mx-6 w-px h-8 bg-white/20" />
        </div>
      </div>
    </div>
  </div>
