<template>
  <div class="frequent-content-widget bg-white rounded-lg shadow-md p-6 h-full">
    ...
    <div v-else-if="error" class="text-center py-8">
      ...
      <p class="text-gray-500">Failed to load content data</p>
      <button @click="fetchData" class="mt-2 text-purple-600 hover:text-purple-800 text-sm font-medium">
        Try Again
      </button>
    </div>

    <!-- Content List -->
    <div v-else-if="contentList.length > 0" class="space-y-3">
      <div v-for="(content, index) in contentList" :key="content.id" 
        ...
        <!-- Trend Indicator -->
        <div class="flex-shrink-0">
          <div v-if="content.trend === 'up'" class="text-green-500">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
            </svg>
          </div>
          <div v-else-if="content.trend === 'down'" class="text-red-500">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div v-else class="text-center py-8">
      ...
      <p class="text-gray-500">No content visits yet</p>
    </div>

    <!-- Footer -->
    <div v-if="contentList.length > 0" class="mt-4 pt-4 border-t border-gray-200">
      <button @click="viewAllContent" class="w-full text-center text-sm text-purple-600 hover:text-purple-800 font-medium">
